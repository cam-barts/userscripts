...
Sentence Count: ${sentenceCount}
  ...
  function analyzeSentence(sentence) {
    ...
    // Coleman-Liau Index: Grade level
    const coleman = wordCount > 0
      ? 0.0588 * ((characterCount / wordCount) * 100) - 0.296 * ((sentenceCount / wordCount) * 100) - 15.8
      : 0;

    // Flesch Reading Ease: Higher = easier (60-70 = standard)
    const flesch = wordCount > 0 && totalSyllables > 0
  ...
  function createTooltip(metrics, difficulty) {
    ...
    const severityLabel = difficulty === 'very-hard' ? 'Very Hard to Read' : 'Hard to Read';
    ...
    tooltip.innerHTML = `
      ...
      <div style="margin-top: 6px; font-size: 12px; border-top: 1px solid #34495e; padding-top: 6px;">
        ...
        <div style="margin-left: 8px;">
          ...
          <div>Coleman-Liau: ${formatScore(metrics.coleman, 10, false)} (Target: ≤10)</div>
          <div>Flesch: ${formatScore(metrics.flesch, 60, true)} (Target: ≥60)</div>
